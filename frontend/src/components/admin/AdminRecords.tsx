...
import { orderStatusLabel, orderStatusLabels, roleLabel, roleLabels, ticketStatusLabel, ticketStatusLabels } from "@/lib/labels";
...
export function AdminRecords({ kind }: { kind: RecordKind }) {
  ...
  const options = Object.entries(kind === "orders" ? orderStatusLabels : kind === "tickets" ? ticketStatusLabels : roleLabels);
