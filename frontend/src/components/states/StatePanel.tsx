...
export function StatePanel({
  ...
  return (
    <div className="flex min-h-64 flex-col items-center justify-center rounded-2xl border border-dashed border-white/12 bg-card/45 px-6 py-12 text-center">
      ...
      <h2 className="font-medium text-white">{title ?? (kind === "loading" ? "Carregando" : kind === "error" ? "Algo saiu do pulso" : "Nada por aqui ainda")}</h2>
